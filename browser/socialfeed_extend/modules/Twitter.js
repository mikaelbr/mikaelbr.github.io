...
var TwitterTemplate = fs.readFileSync(__dirname + '/../templates/Twitter.html');
var RetweetTemplate = fs.readFileSync(__dirname + '/../templates/TwitterRetweet.html');
...
module.exports = SocialFeed.Modules.extend({
